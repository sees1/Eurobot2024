...
void GripperMove::liftFeedbackCB (const lift_action::InterfaceFeedback::ConstPtr& feedback)
{
...
void GripperMove::execute_callback(const behavior_tree_core::BTGoalConstPtr &goal)
{
  ...
  lift_action::InterfaceGoal goal_msg;
