    ...
    try:
        ...
        while(1):
            ...
            if key == 'w' :
                ...
                target_angular_vel = checkAngularLimitVelocity(target_angular_vel + 0.05)
                status = status + 1
                print(vels(target_linear_vel, target_y_vel,target_angular_vel))
            elif key == 'e' :
                target_angular_vel = checkAngularLimitVelocity(target_angular_vel - 0.05)
            ...
            control_linear_vel = makeSimpleProfile(control_linear_vel, target_linear_vel, (0.04/0.05))
            twist.linear.y = 0.0; twist.linear.x = target_linear_vel; twist.linear.z = 0.0

            control_angular_vel = makeSimpleProfile(control_angular_vel, target_angular_vel, (0.06/0.05))
            twist.angular.x = 0.0; twist.angular.y = 0.0; twist.angular.z = target_angular_vel

            control_y_vel = makeSimpleProfile(control_y_vel, target_y_vel, (0.04/0.05))
